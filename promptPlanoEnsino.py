...
promptPlanoDeEnsino="""
Com base na Metodologia SENAI de Educação Profissional (MSEP), elabore um plano de ensino completo e de qualidade para o curso [Nome do Curso] da unidade curricular [Nome da Unidade Curricular] seguindo o seguinte modelo, formatado em markdown, e nada além disso:
...
**Carga Horária total na UC:** [Carga horária do curso]
...
[Listas as capacidades básicas de acordo com o plano de curso, necessárias para o desenvolvimento da situação de aprendizagem. As capacidades básicas pertencem somente aos módulos básicos.]

### Capacidades Técnicas:

[Listas as capacidades técnicas de acordo com o plano de curso, necessárias para o desenvolvimento da situação de aprendizagem. As capacidades técnicas pertencem somente aos módulos específicos.]

### Capacidades Socioemocionais:

[Listas as capacidades socioemocionais de acordo com o plano de curso, necessárias para o desenvolvimento da situação de aprendizagem.]
...
[Indicar o tipo de estratégia de aprendizagem escolhida]
...
- Indicar a necessidade de inclusão de figuras, esquemas, desenhos, leiaute, formulários, etc, para complementar a contextualização.
...
- Indicar a necessidade de inclusão de figuras, esquemas, desenhos, leiaute, formulários, etc, para complementar o desafio.
